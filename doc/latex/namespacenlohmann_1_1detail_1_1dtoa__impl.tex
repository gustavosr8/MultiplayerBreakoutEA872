...
\subsubsection[{\texorpdfstring{append\+\_\+exponent(char $\ast$buf, int e)}{append_exponent(char *buf, int e)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf J\+S\+O\+N\+\_\+\+H\+E\+D\+L\+E\+Y\+\_\+\+R\+E\+T\+U\+R\+N\+S\+\_\+\+N\+O\+N\+\_\+\+N\+U\+LL} char$\ast$ nlohmann\+::detail\+::dtoa\+\_\+impl\+::append\+\_\+exponent (
...
\subsubsection[{\texorpdfstring{format\+\_\+buffer(char $\ast$buf, int len, int decimal\+\_\+exponent, int min\+\_\+exp, int max\+\_\+exp)}{format_buffer(char *buf, int len, int decimal_exponent, int min_exp, int max_exp)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf J\+S\+O\+N\+\_\+\+H\+E\+D\+L\+E\+Y\+\_\+\+R\+E\+T\+U\+R\+N\+S\+\_\+\+N\+O\+N\+\_\+\+N\+U\+LL} char$\ast$ nlohmann\+::detail\+::dtoa\+\_\+impl\+::format\+\_\+buffer (
\begin{DoxyParamCaption}
\item[{char $\ast$}]{buf, }
\item[{int}]{len, }
