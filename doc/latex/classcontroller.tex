...
checa se uma tecla previamente estabelecida foi pressionada, encerrando a execução e fechando o programa (Tecla Q) \index{controller@{controller}!start@{start}}
